...
public:
	GameState() {
		...
		// NEW: initialize damage/heal timers
		lastDamageTime = 0.0f;
		damageCooldown = 1.0f;  // take damage once per second max
		lastHealTime = 0.0f;
		healCooldown = 3.0f;    // heal every 3 seconds when safe
		healAmount = 1;         // restore 1 health per tick
